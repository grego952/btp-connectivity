...
> ### Sample Code:  
> ```
> docker pull docker.io/sapse/connectivity-proxy:2.11.0
> 
> ```
...
```
docker pull 73554900100900005672.dockersrv.cdn.repositories.cloud.sap/com.sap.cloud.connectivity/connectivity-proxy:2.11.0
...
helm pull connectivity/connectivity-proxy --version=2.11.0
```
